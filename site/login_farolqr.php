...
if(isset($_SESSION["loggedin_odonto2"]) && $_SESSION["loggedin_odonto2"] === true){
    header("location: https://carlitoslocacoes.com/painel.php");
    exit;
}
    ...
    <div class="wrapper">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <div class="form-group">
                ...
                <a class="btn btn-info btn-xl" href="https://carlitoslocacoes.com/site/locason.php" role="button">Início</a>
            </div>
